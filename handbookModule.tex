...
\title{Manual del\\Módulo de Integración de Información Cartográfica\\e Información Geoespacial\\} %Con este nombre se guardará el proyecto en writeLaTex
\author{M.en F.C. Gustavo Magallanes Guijón}
\date{}
\thispagestyle{empty}
\maketitle
